   ...
   Begin VB.Frame fraDevelopment 
      ...
      Begin VB.Frame fraDevelopmentInner 
         ...
         Begin VB.ComboBox cmbDebug 
            Height          =   315
            ItemData        =   "frmPrefs.frx":6037
            Left            =   1530
            List            =   "frmPrefs.frx":6039
            Style           =   2  'Dropdown List
            TabIndex        =   54
...
Private Sub chkDpiAwareness_Click()
    ...
    If prefsStartupFlg = False Then ' don't run this on startup
        ...
        sPutINISetting "Software\PzCPUGauge", "dpiAwareness", PzGDpiAwareness, PzGSettingsFile
...
Private Sub chkEnablePrefsTooltips_Click()
   ...
   On Error GoTo chkEnablePrefsTooltips_Click_Error
    ...
    If prefsStartupFlg = False Then
        ...
        sPutINISetting "Software\PzCPUGauge", "enablePrefsTooltips", PzGEnablePrefsTooltips, PzGSettingsFile
...
Private Sub cmbDebug_Click()
    ...
    If cmbDebug.ListIndex = 0 Then
        txtDefaultEditor.Text = "eg. E:\vb6\Panzer CPU Gauge VB6\Panzer CPU Gauge.vbp"
...
'    End If
    ...
    If PzGStartup = "1" Then
        Call savestring(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "PzCPUGaugeWidget", """" & App.path & "\" & "Panzer CPU Gauge.exe""")
    Else
        Call savestring(HKEY_CURRENT_USER, "SOFTWARE\Microsoft\Windows\CurrentVersion\Run", "PzCPUGaugeWidget", vbNullString)
    End If

    ' save the values from the general tab
    If fFExists(PzGSettingsFile) Then
        sPutINISetting "Software\PzCPUGauge", "enableTooltips", PzGEnableTooltips, PzGSettingsFile
        sPutINISetting "Software\PzCPUGauge", "enablePrefsTooltips", PzGEnablePrefsTooltips, PzGSettingsFile
        sPutINISetting "Software\PzCPUGauge", "enableBalloonTooltips", PzGEnableBalloonTooltips, PzGSettingsFile
        sPutINISetting "Software\PzCPUGauge", "showTaskbar", PzGShowTaskbar, PzGSettingsFile
        sPutINISetting "Software\PzCPUGauge", "dpiAwareness", PzGDpiAwareness, PzGSettingsFile
        
        
        sPutINISetting "Software\PzCPUGauge", "gaugeSize", PzGGaugeSize, PzGSettingsFile
        sPutINISetting "Software\PzCPUGauge", "scrollWheelDirection", PzGScrollWheelDirection, PzGSettingsFile
...
'        sPutINISetting "Software\PzCPUGauge", "mainDaylightSaving", PzGMainDaylightSaving, PzGSettingsFile
        'sPutINISetting "Software\PzCPUGauge", "secondaryGaugeTimeZone", PzGSecondaryGaugeTimeZone, PzGSettingsFile
        'sPutINISetting "Software\PzCPUGauge", "secondaryDaylightSaving", PzGSecondaryDaylightSaving, PzGSettingsFile
        
        sPutINISetting "Software\PzCPUGauge", "aspectHidden", PzGAspectHidden, PzGSettingsFile
        sPutINISetting "Software\PzCPUGauge", "widgetPosition", PzGWidgetPosition, PzGSettingsFile
        sPutINISetting "Software\PzCPUGauge", "widgetLandscape", PzGWidgetLandscape, PzGSettingsFile
        sPutINISetting "Software\PzCPUGauge", "widgetPortrait", PzGWidgetPortrait, PzGSettingsFile

        sPutINISetting "Software\PzCPUGauge", "prefsFont", PzGPrefsFont, PzGSettingsFile
        sPutINISetting "Software\PzCPUGauge", "clockFont", PzGClockFont, PzGSettingsFile
        
        sPutINISetting "Software\PzCPUGauge", "prefsFontSizeHighDPI", PzGPrefsFontSizeHighDPI, PzGSettingsFile
        sPutINISetting "Software\PzCPUGauge", "prefsFontSizeLowDPI", PzGPrefsFontSizeLowDPI, PzGSettingsFile
        sPutINISetting "Software\PzCPUGauge", "prefsFontItalics", PzGPrefsFontItalics, PzGSettingsFile
        sPutINISetting "Software\PzCPUGauge", "prefsFontColour", PzGPrefsFontColour, PzGSettingsFile

        'save the values from the Windows Config Items
        sPutINISetting "Software\PzCPUGauge", "windowLevel", PzGWindowLevel, PzGSettingsFile
        sPutINISetting "Software\PzCPUGauge", "preventDragging", PzGPreventDragging, PzGSettingsFile
        
        sPutINISetting "Software\PzCPUGauge", "opacity", PzGOpacity, PzGSettingsFile
        sPutINISetting "Software\PzCPUGauge", "widgetHidden", PzGWidgetHidden, PzGSettingsFile
        sPutINISetting "Software\PzCPUGauge", "hidingTime", PzGHidingTime, PzGSettingsFile
        sPutINISetting "Software\PzCPUGauge", "ignoreMouse", PzGIgnoreMouse, PzGSettingsFile
        
        
        sPutINISetting "Software\PzCPUGauge", "startup", PzGStartup, PzGSettingsFile

        sPutINISetting "Software\PzCPUGauge", "enableSounds", PzGEnableSounds, PzGSettingsFile
        sPutINISetting "Software\PzCPUGauge", "lastSelectedTab", PzGLastSelectedTab, PzGSettingsFile
        
        sPutINISetting "Software\PzCPUGauge", "debug", PzGDebug, PzGSettingsFile
        sPutINISetting "Software\PzCPUGauge", "dblClickCommand", PzGDblClickCommand, PzGSettingsFile
        sPutINISetting "Software\PzCPUGauge", "openFile", PzGOpenFile, PzGSettingsFile
        sPutINISetting "Software\PzCPUGauge", "defaultEditor", PzGDefaultEditor, PzGSettingsFile
        
        sPutINISetting "Software\PzCPUGauge", "clockHighDpiXPos", PzGClockHighDpiXPos, PzGSettingsFile
        sPutINISetting "Software\PzCPUGauge", "clockHighDpiYPos", PzGClockHighDpiYPos, PzGSettingsFile
        
        sPutINISetting "Software\PzCPUGauge", "clockLowDpiXPos", PzGClockLowDpiXPos, PzGSettingsFile
        sPutINISetting "Software\PzCPUGauge", "clockLowDpiYPos", PzGClockLowDpiYPos, PzGSettingsFile
...
'    cmbMainDaylightSaving.ListIndex = Val(PzGMainDaylightSaving)
    ...
    txtDefaultEditor.Text = PzGDefaultEditor
    lblGitHub.Caption = "You can find the code for the Panzer CPU Gauge on github, visit by double-clicking this link https://github.com/yereverluvinunclebert/ Panzer-CPU-Gauge-VB6"
...
Private Sub fraConfigInner_MouseMove(Button As Integer, Shift As Integer, x As Single, y As Single)
    If PzGEnableBalloonTooltips = "1" Then CreateToolTip fraConfigInner.hwnd, "The configuration panel is the location for optional configuration items. These items change how Pz CPU gauge operates, configure them to suit your needs and your mode of operation.", _
...
Private Sub fraConfig_MouseMove(Button As Integer, Shift As Integer, x As Single, y As Single)
    If PzGEnableBalloonTooltips = "1" Then CreateToolTip fraConfig.hwnd, "The configuration panel is the location for optional configuration items. These items change how Pz CPU gauge operates, configure them to suit your needs and your mode of operation.", _
                  TTIconInfo, "Help on Configuration", , , , True
...
Private Sub sliSamplingInterval_Click()
    ...
    If prefsStartupFlg = False Then
        ...
        frmMultiCore.tmrMultiCore.Interval = Val(PzGSamplingInterval) * 1000
        sPutINISetting "Software\PzCPUGauge", "samplingInterval", PzGSamplingInterval, PzGSettingsFile
...
'    panzerPrefs.sliAnimationInterval.BackColor = RGB(redC, greenC, blueC)
    ...
    frmMultiCore.BackColor = RGB(redC, greenC, blueC)
    
    sPutINISetting "Software\PzCPUGauge", "skinTheme", PzGSkinTheme, PzGSettingsFile
