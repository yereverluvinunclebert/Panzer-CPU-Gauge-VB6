...
Private Sub chkDpiAwareness_Click()
    ...
    If prefsStartupFlg = False Then ' don't run this on startup
        ...
        sPutINISetting "Software\PzCPUGauge", "dpiAwareness", gblDpiAwareness, gblSettingsFile
...
Private Sub chkEnablePrefsTooltips_Click()
   ...
   On Error GoTo chkEnablePrefsTooltips_Click_Error
    ...
    If prefsStartupFlg = False Then
        ...
        sPutINISetting "Software\PzCPUGauge", "enablePrefsTooltips", gblEnablePrefsTooltips, gblSettingsFile
...
'    End If
    ...
    If fFExists(gblSettingsFile) Then
        sPutINISetting "Software\PzCPUGauge", "enableTooltips", gblEnableTooltips, gblSettingsFile
        sPutINISetting "Software\PzCPUGauge", "enablePrefsTooltips", gblEnablePrefsTooltips, gblSettingsFile
        sPutINISetting "Software\PzCPUGauge", "enableBalloonTooltips", gblEnableBalloonTooltips, gblSettingsFile
        sPutINISetting "Software\PzCPUGauge", "showTaskbar", gblShowTaskbar, gblSettingsFile
        sPutINISetting "Software\PzCPUGauge", "dpiAwareness", gblDpiAwareness, gblSettingsFile
        
        
        sPutINISetting "Software\PzCPUGauge", "gaugeSize", gblGaugeSize, gblSettingsFile
        sPutINISetting "Software\PzCPUGauge", "scrollWheelDirection", gblScrollWheelDirection, gblSettingsFile
                
        sPutINISetting "Software\PzCPUGauge", "gaugeFunctions", gblGaugeFunctions, gblSettingsFile
        sPutINISetting "Software\PzCPUGauge", "pointerAnimate", gblPointerAnimate, gblSettingsFile
        sPutINISetting "Software\PzCPUGauge", "samplingInterval", gblSamplingInterval, gblSettingsFile
        sPutINISetting "Software\PzCPUGauge", "multiCoreEnable", gblMultiCoreEnable, gblSettingsFile
        
        'sPutINISetting "Software\PzCPUGauge", "clockFaceSwitchPref", gblClockFaceSwitchPref, gblSettingsFile
'        sPutINISetting "Software\PzCPUGauge", "mainGaugeTimeZone", gblMainGaugeTimeZone, gblSettingsFile
'        sPutINISetting "Software\PzCPUGauge", "mainDaylightSaving", gblMainDaylightSaving, gblSettingsFile
        'sPutINISetting "Software\PzCPUGauge", "secondaryGaugeTimeZone", gblSecondaryGaugeTimeZone, gblSettingsFile
        'sPutINISetting "Software\PzCPUGauge", "secondaryDaylightSaving", gblSecondaryDaylightSaving, gblSettingsFile
        
        sPutINISetting "Software\PzCPUGauge", "aspectHidden", gblAspectHidden, gblSettingsFile
        sPutINISetting "Software\PzCPUGauge", "widgetPosition", gblWidgetPosition, gblSettingsFile
        sPutINISetting "Software\PzCPUGauge", "widgetLandscape", gblWidgetLandscape, gblSettingsFile
        sPutINISetting "Software\PzCPUGauge", "widgetPortrait", gblWidgetPortrait, gblSettingsFile

        sPutINISetting "Software\PzCPUGauge", "prefsFont", gblPrefsFont, gblSettingsFile
        sPutINISetting "Software\PzCPUGauge", "clockFont", gblClockFont, gblSettingsFile
        ...
        sPutINISetting "Software\PzCPUGauge", "startup", gblStartup, gblSettingsFile
        ...
        sPutINISetting "Software\PzCPUGauge", "defaultEditor", gblDefaultEditor, gblSettingsFile
        
        sPutINISetting "Software\PzCPUGauge", "clockHighDpiXPos", gblClockHighDpiXPos, gblSettingsFile
        sPutINISetting "Software\PzCPUGauge", "clockHighDpiYPos", gblClockHighDpiYPos, gblSettingsFile
        
        sPutINISetting "Software\PzCPUGauge", "clockLowDpiXPos", gblClockLowDpiXPos, gblSettingsFile
        sPutINISetting "Software\PzCPUGauge", "clockLowDpiYPos", gblClockLowDpiYPos, gblSettingsFile
...
Private Sub fraConfigInner_MouseMove(Button As Integer, Shift As Integer, x As Single, Y As Single)
    If gblEnableBalloonTooltips = "1" Then CreateToolTip fraConfigInner.hwnd, "The configuration panel is the location for optional configuration items. These items change how Pz CPU gauge operates, configure them to suit your needs and your mode of operation.", _
...
Private Sub fraConfig_MouseMove(Button As Integer, Shift As Integer, x As Single, Y As Single)
    If gblEnableBalloonTooltips = "1" Then CreateToolTip fraConfig.hwnd, "The configuration panel is the location for optional configuration items. These items change how Pz CPU gauge operates, configure them to suit your needs and your mode of operation.", _
                  TTIconInfo, "Help on Configuration", , , , True
...
Private Sub sliSamplingInterval_Click()
    ...
    If prefsStartupFlg = False Then
        ...
        frmMultiCore.tmrMultiCore.Interval = Val(gblSamplingInterval) * 1000
        sPutINISetting "Software\PzCPUGauge", "samplingInterval", gblSamplingInterval, gblSettingsFile
