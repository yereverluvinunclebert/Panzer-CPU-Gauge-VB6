...
Public Sub mainRoutine(ByVal restart As Boolean)
    ...
    Call readSettingsFile("Software\PzCPUGauge", PzGSettingsFile)
...
Private Sub checkFirstTime()
   ...
   On Error GoTo checkFirstTime_Error
    ...
    If PzGFirstTimeRun = "true" Then
        ...
        sPutINISetting "Software\PzCPUGauge", "firstTimeRun", PzGFirstTimeRun, PzGSettingsFile
    End If
...
'        PzGMainDaylightSaving = fGetINISetting(location, "mainDaylightSaving", PzGSettingsFile)
        ...
        ' other
        PzGClockHighDpiXPos = fGetINISetting("Software\PzCPUGauge", "clockHighDpiXPos", PzGSettingsFile)
        PzGClockHighDpiYPos = fGetINISetting("Software\PzCPUGauge", "clockHighDpiYPos", PzGSettingsFile)
        
        PzGClockLowDpiXPos = fGetINISetting("Software\PzCPUGauge", "clockLowDpiXPos", PzGSettingsFile)
        PzGClockLowDpiYPos = fGetINISetting("Software\PzCPUGauge", "clockLowDpiYPos", PzGSettingsFile)
...
Private Sub getToolSettingsFile()
    ...
    PzGSettingsDir = fSpecialFolder(feUserAppData) & "\PzCPUGauge" ' just for this user alone
...
Private Sub handleUnhideMode(ByVal thisUnhideMode As String)
    ...
    If thisUnhideMode = "unhide" Then     'parse the command line
        PzGUnhide = "true"
        sPutINISetting "Software\PzCPUGauge", "unhide", PzGUnhide, PzGSettingsFile
